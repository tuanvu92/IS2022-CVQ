...
class ConvSTFT(nn.Module):
    def __init__(self, win_len, win_inc, fft_len=None, win_type='hamming', feature_type='complex', fix=True):
...
def test_ifft1():
    ...
    print('wav MSE', torch.mean(inputs[..., :outputs2.size(2)] - outputs2) ** 2)
